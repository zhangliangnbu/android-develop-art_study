...
public class OuterVerticalScrollViewGroup2 extends FrameLayout {
	private static final String TAG = "outer";
	private View child;
	public OuterVerticalScrollViewGroup2(@NonNull Context context) {
		super(context);
	}

	public OuterVerticalScrollViewGroup2(@NonNull Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
	}

	public OuterVerticalScrollViewGroup2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
