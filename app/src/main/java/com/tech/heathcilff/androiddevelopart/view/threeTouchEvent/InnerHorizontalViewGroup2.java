...
public class InnerHorizontalViewGroup2 extends FrameLayout {
	private static final String TAG = "inner";
	private View child;
	public InnerHorizontalViewGroup2(@NonNull Context context) {
		super(context);
	}

	public InnerHorizontalViewGroup2(@NonNull Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
	}

	public InnerHorizontalViewGroup2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
